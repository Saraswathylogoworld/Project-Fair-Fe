    ...
    <div className='d-flex justify-content-center align-items-center bg-success p-3'>
      <div className='footer d-flex align-items-center justify-content-evenly'>
        <div style={{ width: '400px' }}>
          <h5 className='textStyle'><i class="fa-brands fa-stack-overflow m-3"></i>Project Fair App</h5>
          <p style={{ textAlign: 'justify' ,color:'black'}} className='textStyle'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Id sapiente neque, dignissimos ullam placeat dolore aliquid doloremque porro ipsum vitae quas ad consectetur? Expedita similique velit, debitis quae ab ea?</p>
        </div>
